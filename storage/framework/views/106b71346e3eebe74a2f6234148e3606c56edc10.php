            ...
            <div class="columns">
                <div class="column">
                    <div class="card">
                        ...
                        <footer class="card-footer">
                            <a href="<?php echo e(route('list.step.one', ['plan_id' => 'nest-1'])); ?>" class="card-footer-item">Sign Up</a>
                        </footer>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <footer class="card-footer">
                            <a href="<?php echo e(route('list.step.one', ['plan_id' => 'nest-2'])); ?>" class="card-footer-item">Sign Up</a>
                        </footer>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <footer class="card-footer">
                            <a href="<?php echo e(route('list.step.one', ['plan_id' => 'nest-3'])); ?>" class="card-footer-item">Sign Up</a>
                        </footer>
                    </div>
                </div>
            </div>
            ...
            <form action="#">
                    ...
                    <div class="column">
                        <div class="field">
                            ...
                            <p class="control">
                                ...
                                <?php echo e($errors->has('name') ? 'is-danger' : ''); ?>" value="<?php echo e(old('name')); ?>">
                            </p>
                    ...
                    <div class="column">
                        <div class="field">
                            ...
                            <p class="control">
                                ...
                                <?php echo e($errors->has('email') ? 'is-danger' : ''); ?>" value="<?php echo e(old('email')); ?>">
                            </p>
                    ...
                    <div class="column">
                        <div class="field">
                            ...
                            <p class="control">
                                ...
                                <?php echo e($errors->has('phone') ? 'is-danger' : ''); ?>" value="<?php echo e(old('phone')); ?>">
                            </p>
                            <?php if($errors->has('phone')): ?>
                                <p class="help is-danger"><?php echo e($errors->first('phone')); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="field">
                            ...
                            <p class="control">
                                ...
                                <?php echo e($errors->has('url') ? 'is-danger' : ''); ?>" value="<?php echo e(old('url')); ?>">
                            </p>
                ...
                <div class="field">
                    ...
                    <p class="control">
                        ...
                        <?php echo e($errors->has('message') ? 'is-danger' : ''); ?>
