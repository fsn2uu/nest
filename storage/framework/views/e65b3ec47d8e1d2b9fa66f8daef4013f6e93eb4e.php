...
<div class="field">
    ...
    <p class="select is-fullwidth">
        <select name="type" id="type" class="select <?php echo e($errors->has('type') ? 'is-danger' : ''); ?>">
            <option value="">Select a Unit Type</option>
            <option <?php echo e(old('type') && old('type') == 'condominium' ? 'selected' : isset($unit) && $unit->type == 'condominium' ? 'selected' : ''); ?> value="condominium">Condo</option>
            <option <?php echo e(old('type') && old('type') == 'townhome' ? 'selected' : isset($unit) && $unit->type == 'townhome' ? 'selected' : ''); ?> value="townhome">Townhome</option>
            <option <?php echo e(old('type') && old('type') == 'villa' ? 'selected' : isset($unit) && $unit->type == 'villa' ? 'selected' : ''); ?> value="villa">Villa</option>
            <option <?php echo e(old('type') && old('type') == 'single' ? 'selected' : isset($unit) && $unit->type == 'single' ? 'selected' : ''); ?> value="single">Single / Detached Home</option>
        </select>
    </p>
...
<div class="field">
    ...
    <p class="select is-fullwidth">
        <select name="state" id="state" class="select <?php echo e($errors->has('state') ? 'is-danger' : ''); ?>">
