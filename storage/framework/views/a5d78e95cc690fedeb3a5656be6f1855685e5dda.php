<div class="field">
    ...
    <p class="control">
        ...
        name="name" id="name" placeholder="Some Company" required value="<?php echo e(isset($company) ? $company->name : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="phone" id="phone" placeholder="(XXX) XXX-XXXX" required value="<?php echo e(isset($company) ? $company->phone : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="email" id="email" placeholder="info@company.com" required value="<?php echo e(isset($company) ? $company->email : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="address" id="address" placeholder="123 Main Street" required value="<?php echo e(isset($company) ? $company->address : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="city" id="city" placeholder="Some City" required value="<?php echo e(isset($company) ? $company->city : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="zip" id="zip" placeholder="Some City" required value="<?php echo e(isset($company) ? $company->zip : ''); ?>">
...
<div class="field">
    ...
    <p class="control">
        ...
        name="url" id="url" placeholder="Some City" required value="<?php echo e(isset($company) ? $company->url : ''); ?>">
