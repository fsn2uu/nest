                ...
                <div class="card-content">
                    ...
                    <form action="<?php echo e(route('register')); ?>" method="post">
                        ...
                        <div class="field">
                            ...
                            <p class="control">
                                <input class="input <?php echo e($errors->has('name') ? 'is-danger' : ''); ?>" type="text" name="name" id="name" placeholder="Your Name Here" required>
                        ...
                        <div class="field">
                            ...
                            <p class="control">
                                <input class="input <?php echo e($errors->has('password_confirmation') ? 'is-danger' : ''); ?>" type="password" name="password_confirmation" id="password_confirmation">
                            </p>
